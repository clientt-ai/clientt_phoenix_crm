i want to make my application multi-tenant/authorization starting with a table called "authz_tenants".  Users can belong to one or more companies.
  ...
  authz_tenant.  Please help me spec this out using ddd and bdd and into proper project specs, feel free to ask me questions 