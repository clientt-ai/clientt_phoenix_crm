defmodule ClienttCrmApp.Repo.Migrations.AddFormsDomain do
  ...
  def up do
    ...
    alter table(:forms) do
      ...
      modify :created_by_id,
             references(:authz_users,
               column: :id,
               name: "forms_created_by_id_fkey",
               type: :uuid,
               prefix: "public"
             )
    end

    create unique_index(:forms, [:company_id, :name], name: "forms_unique_name_per_company_index")

    create unique_index(:forms, [:company_id, :slug], name: "forms_unique_slug_per_company_index")
  ...
  def down do
    ...
    drop_if_exists unique_index(:forms, [:company_id, :slug],
                     name: "forms_unique_slug_per_company_index"
                   )

    drop_if_exists unique_index(:forms, [:company_id, :name],
                     name: "forms_unique_name_per_company_index"
                   )

    drop constraint(:forms, "forms_company_id_fkey")

    drop constraint(:forms, "forms_created_by_id_fkey")
    ...
    drop constraint(:submissions, "submissions_company_id_fkey")
