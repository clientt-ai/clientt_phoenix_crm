defmodule ClienttCrmAppWeb.Router do
  use ClienttCrmAppWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {ClienttCrmAppWeb.Layouts, :root}
  ...
  scope "/", ClienttCrmAppWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {ClienttCrmAppWeb.LiveUserAuth, :live_user_optional}
      #
  ...
  # scope "/api", ClienttCrmAppWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:clientt_crm_app, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ClienttCrmAppWeb.Telemetry
